 ...
 * por jugador (endpoint ranking.php). Misma disposición visual que /rankingfinal:
 * categorías en grid y, al hacer click en un jugador, desglose por etapa en línea
 * resaltando las etapas cuyos puntos cuentan.
 */
...
/** Ancho fijo por columna del desglose (Etapa, Lugar, Score, Puntos) */
const COL = 'w-1/4';
...
const Ranking = () => {
  ...
  /** Jugador con el desglose abierto (null = ninguno) */
                                          ...
                                          <>
                                            <div className="overflow-x-auto">
                                              <Table className="bg-white tournament-table table-fixed w-full">
                                                <TableHeader>
                                                  <TableRow className="bg-primary hover:bg-primary">
                                                    <TableHead className={`text-primary-foreground font-bold text-right ${COL}`}>
                                                      Etapa
                                                    </TableHead>
                                                    <TableHead className={`text-primary-foreground font-bold text-center ${COL}`}>
                                                      Lugar
                                                    </TableHead>
                                                    <TableHead className={`text-primary-foreground font-bold text-center ${COL}`}>
                                                      Score
                                                ...
                                                <TableBody>
                                                  {detailEtapas.map((etapa) => (
                                                    ...
                                                    >
                                                      <TableCell className={`font-semibold text-right ${COL}`}>
                                                      ...
                                                      <TableCell className={`text-center ${etapa.counted ? 'font-semibold' : ''} ${COL}`}>
                                                        {etapa.lugar ?? '—'}
                                                      </TableCell>
                                                      <TableCell
                                                        className={`text-center ${
                                                          etapa.counted ? 'font-bold text-foreground' : 'text-muted-foreground'
                                                        } ${COL}`}
                                                      >
                                                        {etapa.score ?? '—'}
                                                      </TableCell>
                                                      <TableCell
                                                        className={`text-center ${
                                                          etapa.counted ? 'font-bold text-primary' : 'text-muted-foreground'
                                                        } ${COL}`}
                                                      >
                                                  ...
                                                  <TableRow className="bg-muted hover:bg-muted">
                                                    ...
                                                    <TableCell className="text-center font-bold text-primary">
                                                      {formatPuntos(detail?.totalContado ?? 0)}
                                                    </TableCell>
                                                  </TableRow>
                                                </TableBody>
                                              </Table>
